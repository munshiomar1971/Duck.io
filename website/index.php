...
<body>
    <nav>
        <ul>
            <li><h1><a href="index.php"><b>Duck.io</b><i class="fas fa-feather-alt"></i></a></h1></li>
    ...
    <div class="bio" align="center">
        <section class="about">
            ...
            <p><a href="about.php">Click here to learn more about us.</a></p>
            <p><a href="duck.php">Or click here to learn about ducks</a></p>
        </section>
    </div>
    <br><br><br><br><br>
